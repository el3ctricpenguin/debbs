...
const deBBSModule = buildModule("deBBSModule", (m) => {
  ...
  // m.call(deBBS, "createBoard", ["Ethereum", "Let's talk about Ethereum", "#000000", "#FFFFFF", "0x391EDb04A93549fAf95BeeD8244B7DD494003c80"],
  //   {value: ethers.parseEther("0.01"), id:"a01_CreateBoard" });
  m.call(deBBS, "createBoard", ["DeFi", "DeFi is the future.", "#00FF00", "#FF00FF", "0x391EDb04A93549fAf95BeeD8244B7DD494003c80"], 
    {value: ethers.parseEther("0.01"), id:"a02_CreateBoard" });
  // m.call(deBBS, "createBoard", ["Trading", "Degen is the next human", "#0000FF", "#00FFFF", "0x391EDb04A93549fAf95BeeD8244B7DD494003c80"],
  ...
  // m.call(deBBS, "createPost", [3, 4, "Does anyone still remember EtherDelta? I’ve been feeling nostalgic lately and realized it was one of the first decentralized exchanges I used. It wasn’t pretty—orders constantly stuck, and the UI was a nightmare, but it was a huge step forward at the time. Hard to believe how far DeFi has come since then!", "0x391EDb04A93549fAf95BeeD8244B7DD494003c80"], {value: ethers.parseEther("0.0001"), id:"a13_CreatePost"});
  m.call(deBBS, "createPost", [1, 5, "Ah, EtherDelta! The good old days of decentralized trading before DEXs became all shiny and user-friendly. It was like the wild west—slow transactions, clunky interface, and if you weren’t careful, you could easily send your tokens into the abyss.", "0x391EDb04A93549fAf95BeeD8244B7DD494003c80"], {value: ethers.parseEther("0.0001"), id:"a14_CreatePost"});
  // m.call(deBBS, "createPost", [3, 6, "Uniswap.", "0x391EDb04A93549fAf95BeeD8244B7DD494003c80"], {value: ethers.parseEther("0.0001"), id:"a15_CreatePost"});
  m.call(deBBS, "createPost", [3, 7, "You can use DEX aggregators like 1inch.", "0x391EDb04A93549fAf95BeeD8244B7DD494003c80"], {value: ethers.parseEther("0.0001"), id:"a16_CreatePost"});
